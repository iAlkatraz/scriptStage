...
# RICORDA DI IMPOSTARE IL NOME DEL FILE CONF.YML CORRETTO PRIMA DELL'ESPORTAZIONE IN FILE.EXE
...
# ESEMPIO: se attualemente sono le 17:00:00, lo script cercherà dati nella finestra temporale qualetest
